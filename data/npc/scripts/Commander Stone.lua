...
local function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "mission")) then
		...
		elseif player:getStorageValue(Storage.BigfootBurden.QuestLine) >= 16 then
			npcHandler:say({
				"For your {rank} there are four missions avaliable: {crystal keeper}, {spark hunting}, {monster extermination} and {mushroom digging}. By the way, your {rank} now allows you to take aditional missions from {Gnomeral} in {Gnomebase Alpha}. ... ",
				"If you lose a mission item you can probably buy it from Gnomally. "
			}, cid)
			npcHandler.topic[cid] = 0
		end
