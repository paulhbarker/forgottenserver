...
local WAYPOINTS = {
    [1] = { name = "Venore", position = Position(32962, 32076, 7) }, -- 41876
    [2] = { name = "Thais", position = Position(32369, 32235, 7) }, -- 41877
    [3] = { name = "Kazordoon", position = Position(32644, 31925, 11) }, -- 41878
    [4] = { name = "Carlin", position = Position(32360, 31781, 9) }, -- 41879
    [5] = { name = "Ab\'Dendriel", position = Position(32732, 31630, 7) }, -- 41880
    [6] = { name = "Liberty Bay", position = Position(32317, 32828, 7) }, -- 41881
    [7] = { name = "Port Hope", position = Position(32595, 32748, 7) }, -- 41882
    [8] = { name = "Ankrahmun", position = Position(33195, 32851, 4) }, -- 41883
    [9] = { name = "Darashia", position = Position(33212, 32455, 2) }, -- 41884
    [10] = { name = "Edron", position = Position(33223, 31814, 8) }, -- 41885
    [11] = { name = "Svargrond", position = Position(32212, 31133, 8) }, -- 41886
    [12] = { name = "Yalahar", position = Position(32793, 31272, 7) }, -- 41887
    [13] = { name = "Farmine", position = Position(33023, 31525, 11) }, -- 41888
...
local SECRET_WAYPOINT = { name = "???", position = Position(973, 1242, 7) }
